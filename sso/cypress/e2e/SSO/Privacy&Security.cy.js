...
/*describe('Privacy & Security Test Cases', () => {
    ...
    it('TC-Priv&Sec-01 : To check the functionality of Privacy and Security tab is viewable', () => {
     ...
     it('TC-Priv&Sec-02 : To check the functionality of "Go to the Security tab"', () => {
     ...
     it.ony('TC-Priv&Sec-03 : Verify that the Security tab is highlighted', () => {
     ...
     it('TC-Priv&Sec-04 : To check the functionality of "Enable two way authentication" link is shown', () => {
    ...
    it('TC-Priv&Sec-05 : To check the functionality "Enable two way Auth" link is working', () => {
        ...
        //cy.get('Enable Two Way Auth').should("be.visible")  
    });
    it('TC-Priv&Sec-06 : To check the  "Yes or No" option available', () => {
    ...
    it('TC-Priv&Sec-07 : To check the functionality of "Click on Yes button" option is available', () => {
    ...
    it('TC-Priv&Sec-08 : To check the functionality of "No button" option is available', () => {
          cy.wait(2000)   
        cy.contains("Privacy & Security").click();
        cy.wait(1000)
    ...
    it('TC-Priv&Sec-09 : To check the functionality of "Next  button" is clickable', () => {
    ...
    it('TC-Priv&Sec-10 : To check the functionality of "Cancel  button" is clickable', () => {
    ...
    it('TC-Priv&Sec-11 : To check the functionality of "Password" field is working when enabled the two way authentication', () => {
    ...
    it('TC-Priv&Sec-12 :To check the functionality of "Password field placeholder" ', () => {
