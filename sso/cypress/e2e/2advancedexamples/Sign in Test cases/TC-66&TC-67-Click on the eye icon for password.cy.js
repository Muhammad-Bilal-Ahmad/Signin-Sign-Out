...
describe("Verify the functionality to click on the eye icon for password", function(){
    beforeEach(() => {
    ...
    it("Verify the functionality to click on the eye icon for password"  ,function(){
