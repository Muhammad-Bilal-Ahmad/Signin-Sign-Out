...
describe("Verify the functionality to reset password with upper and lower case combinations", function(){
    beforeEach(() => {
    ...
    it("Verify the functionality to reset password with upper and lower case combinations"  ,function(){
