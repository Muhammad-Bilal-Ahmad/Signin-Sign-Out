...
describe('TC-36 To check the functionality on resend code for disable account', function(){

   

    it('TC-36 To check the functionality on resend code for disable account',function(){
