...
describe('TC-32&TC-35 To check the functionality on Enter invalid password on disable password field', function(){

   

    it('TC-32&TC-35 To check the functionality on Enter invalid password on disable password field',function(){
...
//        cy.get('#password').invoke('removeAttr', 'class')
        ...
        cy.contains('Credentials are incorrect!').should("be.visible")
